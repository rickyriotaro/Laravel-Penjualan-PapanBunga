                                ...
                                <div class="p-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <a href="{{ route('auth.login') }}" class="nav-link text-center"><span style="font-size: 12px;">Sudah punya akun? </span><span style="font-size: 12px; color: #3CACAE">Masuk</span></a>
                                        </div>
                                    </div>
                                    <br />
                                    <form action="{{ route('postRegister') }}" method="POST">
                                        ...
                                        <div class="mb-3 d-grid gap-2">
                                            <button type="submit" name="daftar" class="btn" style="background-color:  #3CACAE"><span style="color: white">Daftar</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="container text-center text-md-left">
                <div class="row text-center text-md-left">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p class="text-white"><i class="fas fa-home mr-3"></i>Pangkalan Batang, Bengkalis.
                        </p>
