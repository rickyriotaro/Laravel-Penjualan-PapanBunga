...
<body>
    ...
    <nav class="navbar bg-body-tertiary shadow">
        <div class="container">
            ...
            <ul class="nav justify-content-end nav-underline">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="{{ route('user.produk') }}">Produk</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="card shadow" style="background-color: #f8f1f6; border: none">
            <div class="card-body">
                <br>
                <h1 class="card-title fw-bold" style="color: #8B008B">
                    Selamat Datang {{ Auth::user()->nama }} !
                </h1>
                <h5 class="card-title text-dark">
                    Anda telah login sebagai User
                </h5>
            </div>
            <div class="container">
                <a href="/user/produk"><button type="button" class="btn btn text-white fw-bold" style="background-color: #8B008B">
                        Ayo Cek Produk
                    </button></a>
                <br />
                <br />
